...
# Dosya yolu
dosya_yolu = 'vid.mp4'  # Video dosyası için
#dosya_yolu = '1.jpg'  # Resim dosyası için
...
while True:
    ...
    results = model.predict("ak.mp4", imgsz=800, conf=threshold)  # Doğrudan NumPy dizisini kullan
