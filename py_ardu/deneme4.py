...
# Dosya yolu
dosya_yolu = 'ak.mp4'  # Video dosyası için
...
while True:
    ...
    for result in results:
        ...
        if ak47_detected:
            cv2.putText(frame, "ak47 tespit edildi", (int(frame.shape[1] / 2 - 100), int(frame.shape[0] - 10)),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
        else:
            cv2.putText(frame, "silah tespit edilmedi", (int(frame.shape[1] / 2 - 100), int(frame.shape[0] - 10)),
